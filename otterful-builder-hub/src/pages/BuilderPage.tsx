    ...
    <div className="builder-shell">
      ...
      <section className="export-panel">
        ...
        <p className="panel-hint">
          ...
          <code className="mono">shirt</code>, <code className="mono">glasses</code>). Wearable ids are sent as stems — align
          with your Storage filenames or use full URLs in data later.
        </p>
